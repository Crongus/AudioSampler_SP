...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, Keypad_R1_Pin|Keypad_R2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(Keypad_R3_GPIO_Port, Keypad_R3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, GPIO_PIN_6|Keypad_R4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : Keypad_C5_Pin Keypad_C4_Pin Keypad_C3_Pin */
  GPIO_InitStruct.Pin = Keypad_C5_Pin|Keypad_C4_Pin|Keypad_C3_Pin;
