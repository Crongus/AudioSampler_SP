...
(library Library_1
	...
	(symbolDef "AS4C8M16SA-6TCN" (originalName "AS4C8M16SA-6TCN")
	...
	(compDef "AS4C8M16SA-6TCN" (originalName "AS4C8M16SA-6TCN") (compHeader (numPins 54) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "16" (pinName "WE#") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "17" (pinName "CAS#") (partNum 1) (symPinNum 17) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "18" (pinName "RAS#") (partNum 1) (symPinNum 18) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "19" (pinName "CS#") (partNum 1) (symPinNum 19) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "20" (pinName "BA0") (partNum 1) (symPinNum 20) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "21" (pinName "BA1") (partNum 1) (symPinNum 21) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "40" (pinName "NC/RFU") (partNum 1) (symPinNum 42) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "36" (pinName "NC") (partNum 1) (symPinNum 46) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AS4C8M16SA-6TCN"))
		...
		(attr "Mouser Part Number" "913-4C8M16SA-6TCN")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Alliance-Memory/AS4C8M16SA-6TCN?qs=os3kWr9Y3%252BAH%252BnoNsfnp3A%3D%3D")
		(attr "Manufacturer_Name" "Alliance Memory")
		(attr "Manufacturer_Part_Number" "AS4C8M16SA-6TCN")
		(attr "Description" "DRAM")
		(attr "Datasheet Link" "https://www.alliancememory.com/wp-content/uploads/pdf/dram/128M-AS4C8M16SA.pdf")
		(attr "Height" "1.2 mm")
	)
